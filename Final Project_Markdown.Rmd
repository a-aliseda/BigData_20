...
kable(lasso_favs_trump_coefs[order(-lasso_favs_trump_coefs)][1:10],
      caption = "Trump's top 10 words with most positive effect on favorites")

## Top 10 words with most negative effect on favs for Trump
kable(lasso_favs_trump_coefs[order(lasso_favs_trump_coefs)][1:10],
      caption = "Trump's top 10 words with most negative effect on favorites")
...
kable(lasso_favs_biden_coefs[order(-lasso_favs_biden_coefs)][1:10],
      caption = "Biden's top 10 words with most positive effect on favorites")

## Top 10 words with most negative effect on favs for Biden
kable(lasso_favs_biden_coefs[order(lasso_favs_biden_coefs)][1:10],
      caption = "Biden's top 10 words with most negative effect on favorites")
...
On the other hand, Biden's tweets have different words that have a positive effect on the number of favorites. For instance, words like 'incendiary', 'inept', 'unqualified', or 'incompetent' have strong positive effects. These words seem to be related to tweets talking about President Trump and his actions during the administration. Including one of this word in a tweet, increases the number of favorites by up to `r lasso_favs_biden_coefs[order(-lasso_favs_biden_coefs)][1]`. Furthermore, 
